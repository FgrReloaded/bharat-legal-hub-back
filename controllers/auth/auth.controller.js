...
module.exports = {
    ...
    RegisterRoute: async (req, res) => {
        ...
        try {
            ...
            //  Creating a new user
            user = await User.create({ ...req.body, password: secPass, isLawer: false });
    ...
    LoginRoute: async (req, res) => {
        ...
        try {
            ...
            // Returning the token as response
            res.json({ success, authToken, isLawer: user.isLawer })
        } catch (error) {
            console.error(error.message);
            res.status(500).send("Internal Server Error Occured")
        }
    ...
    RegisterAdvocateRoute: async (req, res) => {
        ...
        try {
            ...
            //  Creating a new user
            user = await Lawyer.create({ ...req.body, password: secPass, isLawer: true });
